...
void TxTableModel::updateAllData() {    
 ...
 QVariant TxTableModel::data(const QModelIndex &index, int role) const
 {
    ...
    if (role == Qt::DisplayRole) {
        ...
        case Column::Amount: return Settings::getVCCDisplayFormat(dat.amount);
        }
    } 
    ...
    if (role == Qt::ToolTipRole) {
        ...
        case Column::Amount: return Settings::getInstance()->getUSDFromVccAmount(modeldata->at(index.row()).amount);
        }    
    }
