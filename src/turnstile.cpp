...
// Need at least 0.0005 VCC for this
double Turnstile::minMigrationAmount = 0.0005;

// Methods for vcoind native Migration
void Turnstile::showVcoindMigration(MainWindow* parent) {
    ...
    md.lblUnMigrated->setText(Settings::getVCCDisplayFormat(status->unmigrated));
    md.lblMigrated->setText(Settings::getVCCDisplayFormat(status->migrated));
