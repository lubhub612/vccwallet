...
TRANSLATIONS = res/vcc_qt_wallet_es.ts \
               res/vcc_qt_wallet_fr.ts \
               res/vcc_qt_wallet_de.ts \
               res/vcc_qt_wallet_pt.ts \
               res/vcc_qt_wallet_it.ts \
               res/vcc_qt_wallet_zh.ts \
               res/vcc_qt_wallet_tr.ts 
